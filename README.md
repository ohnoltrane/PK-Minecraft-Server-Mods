...
PK Minecraft server has proximity voicechat. The server is playable with vanilla launcher but if you want to **use voicechat**, follow the steps below. *Takes 5 mins max.*
